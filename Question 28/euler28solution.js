...
function fourCornerSum(spiral) {
   let corTotal = 0; // this variable needs to be reset for each spiral, therefore it is contained within the function.
